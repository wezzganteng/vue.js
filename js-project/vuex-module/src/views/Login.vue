  ...
  <div class="flex w-96 flex-col space-y-5 rounded-lg border py-10 px-5 shadow-xl mx-auto">
    ...
    <div>
      <div class="relative mt-2 w-full">
        <input type="text" id="email" v-model="username" class="border-1 peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
    ...
    <div>
      <div class="relative mt-2 w-full">
        <input type="text" id="password" v-model="password"  class="border-1 peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
    ...
    <button class="rounded-lg bg-blue-600 py-3 font-bold text-white"  type="submit">Login</button>
  </div>
</form>
  </div>
</template>
